...
class FuMorphCexSpec extends FlatSpec {

	"The FuMorph library" should "allow export of a FiniteVerbForm" in {
		...
		val cex:String = fm.cex(fvf, "fumorph", "temp", "#")
		println(cex)
	}
	...
	it should "allow export of a Vector of  FiniteVerbForms" in {
		...
		val fm:FuMorph = new FuMorph(Greek)
		val cex:String = fm.cex(Vector(fvf1,fvf2), "fumorph", "temp", "#")
		println(cex)
	}
	...
	it should "allow the export of an InvalidForm" in {
		...
		val fm:FuMorph = new FuMorph(Greek)
		val cex:String = fm.cex(indeclf, "fumorph", "temp", "#")
	...
	it should "allow the export of a vector of InvalidForms as a cex block" in {
		...
		val fm:FuMorph = new FuMorph(Greek)
		val cex:String  = fm.cex(fv, "fumorph", "temp", "#")
		println(cex)
	...
	it should "allow the export of an IndeclinableForm" in {
		...
		val fm:FuMorph = new FuMorph(Greek)
		val cex:String = fm.cex(form, "fumorph", "temp", "#")
		println(cex)
	}
	...
	it should "allow the export of an GerundForm" in {
		...
		val fm:FuMorph = new FuMorph(Latin)
		val cex:String = fm.cex(form, "fumorph", "temp", "#")
		println(cex)
	}
